...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-06-2023 a las 12:58:07
...
INSERT INTO `users` (`id`, `nombre`, `apellido`, `mail`, `contraseña`, `edat`, `nivel`) VALUES
(14, 'admin', 'inistrador', 'admin@dmail.com', '$2y$10$I30RJoiuSzf3aYNAO4wnJezvsD5.ZtIqt0d8OUm394uQmKds9GGmO', 32, 10),
(8, 'Denis22', 'Lazarian', 'denislaza22@dmail.com', '$2y$10$CTRLMKmNNA3yt3WNkW/uVOO85XjSTDSlWm/TTmkfvkHGT6m7H2XbW', 0, 0),
(7, 'Denis', 'lazarian', 'denislaza@dmail.com', '$2y$10$tWBAU/UrJtxTOKxB2ErLVelBVJ4aBxC3XtpCYvd.ht03Ci/Ey8O2u', 0, 5),
(11, 'Pedro', 'Picapiedra', 'PPicapiedra@dmail.com', '$2y$10$f7CDeFHzw2nNMGW.Y0MTme9lYyXp/OonEjQIk2RSqcjbSSbDrqs6K', 33, 8),
(15, 're', 'porter1', 'reporter1@dmail.com', '$2y$10$hWyrPzDU55AuYeEd7fjmZu6WUItFqjWHiaM04D8RU7OWYsaCAxT6C', 22, 6);
